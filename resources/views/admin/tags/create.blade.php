...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">@lang('main.add new tag')</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          ...
          <div class="card-body">
            <form method="post" action="{{route('tags.store')}}" enctype="multipart/form-data">
              ...
              <div class="form-group col-sm-6">
                ...
                <input type="text" name="tag_name" value="{{old('tag_name')}}" class="form-control" id="tag_name" placeholder="@lang('main.enter tag_name')">
              </div>
