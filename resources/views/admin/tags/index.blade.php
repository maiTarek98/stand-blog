  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">@lang('main.show all tags')</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{route('tags.create')}}" class="btn btn-primary">@lang('main.add new tag')</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{$tag->tag_name}}</td>
                  <td>
                      <a class="btn btn-info" href="{{ route('tags.show',$tag->id) }}">@lang('main.show')</a>
                      @can('tag-edit')
                          <a class="btn btn-warning" href="{{ route('tags.edit',$tag->id) }}">@lang('main.edit')</a>
                      @endcan
                      @can('tag-delete')
